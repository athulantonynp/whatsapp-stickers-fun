...
import static com.sticker.athul.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.sticker.athul.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.sticker.athul.StickerContentProvider.PUBLISHER_EMAIL;
import static com.sticker.athul.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.sticker.athul.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.sticker.athul.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
...
public class StickerPackLoader {
    ...
    private static List<Sticker> getStickersForPack(Context context, StickerPack stickerPack) {
        ...
        for (Sticker sticker : stickers) {
            Log.e("NAME",String.valueOf(sticker.imageFileName));
            final byte[] bytes;
            try {
